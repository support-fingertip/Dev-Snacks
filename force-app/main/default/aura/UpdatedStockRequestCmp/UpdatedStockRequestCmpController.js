({
    ...
    addToSelectedProduct: function (component, event,helper) {
        ...
        console.log('has value== '+SelectedProducts.some((SelectedProduct) => productId in SelectedProduct))
        var SelectedProductIds = component.get('v.SelectedProductIds');
        console.log('SelectedProductIds== '+SelectedProductIds)
        if(SelectedProductIds.includes(productId)){
            helper.showToast('Product is already selected.','Information');
        }else{
            ...
            $A.enqueueAction(action);
            component.set('v.cartItems',SelectedProducts.length+1);
        }      
    },
