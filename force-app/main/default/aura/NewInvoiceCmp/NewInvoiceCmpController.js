({
        ...
        if(window.navigator.onLine){
            ...
            action1.setCallback(this, function (response) {
                ...
                if (state == "SUCCESS") {
                    ...
                    if(db != null){
                        if(db.creditPeriodExcd){
                            helper.showToast('Sales invoice can not be created.Customer credit period is exceeded to create Sales invoice.', 'Information');
                            ...
                            var invoice = {};
                            invoice.Customer__c = db.currentvisit.Account1__c;
                            invoice.Visit__c = db.currentvisit.Id;
                            invoice.Daily_logs__c = db.currentvisit.Daily_log__c;
                            invoice.Trip__c = db.currentvisit.Daily_log__r.Trip__c;
    ...
    cartClickOrder : function(component, event, helper){
        ...
        for(var i=0;i<wrapper.length;i++){
            ...
            if(cartProductIds.includes(wrapper[i].stock.Id) && (wrapper[i].quantity != 0 && wrapper[i].quantity != null && wrapper[i].quantity != undefined)){
                ...
                productDiscount = wrapper[i].product.Discount__c || 0;
                ...
                item.Product_Discount_Amount__c = Number(productDiscountAmt).toFixed(2);
                item.Product_Discount__c = Number(productDiscount).toFixed(2);
        ...
        if(invoiceitems.length >0){
            component.set('v.invoiceItemList',invoiceitems);
    ...
    getGrandTotal : function(component, event, helper) {
        ...
        component.set('v.invoiceItemList',oitems);
   ...
   CancelClick: function (component, event) {
    ...
    save: function(component,event,helper) {
        ...
        if (helper.validateInvoiceList(component, event)) {
